...
#exec $BIN --start-server-load-scenario Contest-1-Electronic-Circuit --server-settings ./data/server-settings.json

exec $BIN --start-server-load-scenario "Factorio Contest/Contest-1-Electronic-Circuit" --server-settings ./data/server-settings.json
